                                            ...
                                            unsigned int flags)
{
    ...
    if ((def = virDomainDefParseString(config, privconn->caps, privconn->xmlopt, NULL,
                                       VIR_DOMAIN_DEF_PARSE_INACTIVE)) == NULL)
        goto cleanup;
                             ...
                             unsigned int flags)
{
    ...
    *nparams = 0;
    ...
    if (virDomainGetBlkioParametersAssignFromDef(def, params, nparams, maxparams) < 0)
        goto cleanup;
                                ...
                                unsigned int flags)
{
    ...
    privdom = vm->privateData;
    ret = virDomainDefFormat(privdom->managedDef, privconn->caps, VIR_DOMAIN_DEF_FORMAT_SECURE);
...
static virHypervisorDriver testHypervisorDriver = {
    ...
    .connectDomainXMLFromNative = testConnectDomainXMLFromNative, /* 5.7.0 */
...
static virNetworkDriver testNetworkDriver = {
    ...
    .networkGetDHCPLeases = testNetworkGetDHCPLeases, /* 5.7.0 */
